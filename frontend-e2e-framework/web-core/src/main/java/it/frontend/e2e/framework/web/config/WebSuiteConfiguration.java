...
public class WebSuiteConfiguration extends SuiteConfiguration<XPathSelector, WebLocation, WebPresentationElement, IWebPresentationApiAdapter> {
    ...
    public WebSuiteConfiguration(List<ICapabilityHandler> capabilityHandlers, List<IWebPresentationApiAdapter> presentationApiAdapters) {
        super(capabilityHandlers, presentationApiAdapters);
    }
