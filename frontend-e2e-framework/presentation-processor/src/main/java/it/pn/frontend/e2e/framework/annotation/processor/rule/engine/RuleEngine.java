package it.pn.frontend.e2e.framework.annotation.processor.rule.engine;
...
public final class RuleEngine {
    ...
    public void applyMustHaveAnnotation(ConstraintDescriptor constraint, Set<TypeElement> targets) {
    ...
    private void report(ConstraintDescriptor constraint, TypeElement element) {
