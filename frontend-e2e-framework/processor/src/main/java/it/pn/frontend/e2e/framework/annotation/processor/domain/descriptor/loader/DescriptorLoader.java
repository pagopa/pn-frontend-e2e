...
public final class DescriptorLoader {
    ...
    public List<DomainDescriptor> loadAll(ClassLoader classLoader, Messager messager) {
        Map<String, DomainDescriptor> result = new LinkedHashMap<>();
        ...
        try {
            ...
            while (indexes.hasMoreElements()) {
                ...
                for (DomainDescriptor d : loadDescriptorsFromIndex(indexUrl, classLoader, messager)) {
                    DomainDescriptor previous = result.putIfAbsent(d.domainId, d);
                    if (previous != null) {
                        messager.printMessage(
    ...
    private List<DomainDescriptor> loadDescriptorsFromIndex(URL indexUrl, ClassLoader classLoader, Messager messager) {
        ...
        try (BufferedReader reader =
            ...
            while ((line = reader.readLine()) != null) {
                ...
                DomainDescriptor descriptor = parseAndValidateDescriptor(descriptorUrl, messager);
                if (descriptor != null) {
    ...
    private DomainDescriptor parseAndValidateDescriptor(URL url, Messager messager) {

        try (InputStream in = url.openStream()) {
            DomainDescriptor descriptor = parser.parse(in);
