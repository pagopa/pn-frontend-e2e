Feature: Ricerca notifica per periodo temporale persona fisica
  ...
  Scenario: PN-9441 - Visualizzazione dettaglio notifica inserita con API v.1
    ...
    And Nella pagina Piattaforma Notifiche  persona fisica inserire il codice IUN "JEGU-QMTG-VAVR-202405"
    And Cliccare sul bottone Filtra persona fisica
    And Nella pagina Piattaforma Notifiche persona fisica vengo restituite tutte le notifiche con il codice IUN "JEGU-QMTG-VAVR-202405"
