Feature: Il delegato persona giuridica modifica una delega assegnandoli un gruppo
  Background: Login delegato persona giuridica
    ...
    When Login con persona giuridica "delegatoPG"
  ...
  Scenario: Il delegato persona giuridica modifica una delega assegnandoli un gruppo
    ...
    And Nella pagina Deleghe sezione Deleghe a carico dell'impresa clicca sul menu della delega "personaGiuridica_1"
    ...
    And Si controlla che la delega a cambiato gruppo "personaGiuridica_1"
