Feature: PG - Utente con ruolo Amministratore della PG elimina una virtual key ruotata di un utente con ruolo di operatore
  ...
  Scenario:PN-QA-5345  PG - Utente con ruolo Amministratore della PG elimina una virtual key ruotata di un utente con ruolo di operatore
...
#    Then Verifica Assenza stato Chiave Personale "Bloccata"
#
#    And Verifica stato Chiave Personale "Bloccata"
