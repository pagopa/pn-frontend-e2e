Feature: gruppi
  ...
  Scenario: [TA-FE GRUPPI PERSONA GIURIDICA] - gruppi persona giuridica
    ...
    And Si visualizza correttamente la pagina di riepilogo del gruppo "Gruppo Test6"
    ...
    And Si visualizza correttamente la pagina di riepilogo del gruppo "Copia di Gruppo Test6"
