Feature: La persona giuridica visualizza tutti gli elementi della sezione altri recapiti
  ...
  Scenario: PN-9161 -C1 La persona giuridica inserisce PEC sbagliato e corretto
    ...
    And Nella pagina Recapiti si inserisce il numero di telefono "333456789" e clicca sul bottone avvisami via SMS
    ...
    And Nella sezione altri recapiti si seleziona il tipo di indirizzo PG scegliendo ""
