Feature: Rework della pagina dei contatti
  ...
  @TestSuite
  @TA_REWORK_DOMICILIO_DIGITALE_76_75_74_PG
  @addressBook2
  Scenario:[REWORK_DOMICILIO_DIGITALE_PG_76_75_74] Aggiunta domicilio digitale personalizzato (principale PEC) - Già ente personalizzato attivo - Inserimento per lo stesso ente PG
...
##  REWORK_DOMICILIO_DIGITALE_PG_74
    ...
    And Click Menu Ente Mittente Inserimento ente "Agenzia delle Entrate - Riscossione"
    And Seleziona Tipologia "Indirizzo PEC"
    #    TODO Errore: non preme il tasto Conferma
