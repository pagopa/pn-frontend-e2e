Feature: invio notifica con sequence
  ...
  @Tag_PN_14806_14_OK-GiacenzaCAD-lte10_890
  @TestSuite
  @Tag_CAD_ARCAD
  @NRT

  Scenario: [PN-14806_14] CAD/ARCAD SEQUENCE OK-GiacenzaCAD-lte10_890
    Given PA - Si effettua la login tramite token exchange, e viene visualizzata la dashboard
    And Nella pagina Piattaforma Notifiche cliccare sul bottone Invia una nuova notifica
    And Si visualizza correttamente la pagina Piattaforma Notifiche section Informazioni preliminari
    Then Nella section Informazioni preliminari si inseriscono i dati della notifica
      | oggettoNotifica   | OK-GiacenzaCAD-lte10_890 |
      | descrizione       | OK-GiacenzaCAD-lte10_890 |
      | gruppo            | test-TA-FE               |
    ...
    And Nella section Destinitario si clicca su "Aggiungi un indirizzo fisico" e si inseriscono i dati
      | indirizzo | Via @OK-GiacenzaCAD-lte10_890 |
      | civico    | 20                            |
      | localita  | Milano                        |
      | comune    | Milano                        |
      | provincia | MI                            |
