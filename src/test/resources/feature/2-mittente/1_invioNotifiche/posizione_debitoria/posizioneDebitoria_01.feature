Feature: Mittente genera una notifica tramite destinatario con pec
  ...
  Scenario: Posizione_Debitoria_01_02 - verifica della presenza di "Posizione debitoria" e "Dettagli posizione debitoria" nel form di creazione di una nuova notifica
