...
##  1 Modello F24 con costi
    And Nella pagina piattaforma notifiche destinatario si effettua la ricerca per codice IUN "VLHL-DNMA-URGU-202511-X-1"
    And Cliccare sulla notifica restituita dal filtro
    And Verifica Neumro Copy Costi di notifica Inclusi 1 IUN "VLHL-DNMA-URGU-202511-X-1"
    And Verifica testo "L'importo finale potrebbe essere diverso da quello indicato"
    And Nella sezione Dettaglio Notifiche si clicca su l'opzione Indietro
    And  Aspetta 0 secondi
...
##  2 Modello F24 con costi
    And Nella pagina piattaforma notifiche destinatario si effettua la ricerca per codice IUN "UGVQ-LHRV-LEZN-202511-D-1"
    And Cliccare sulla notifica restituita dal filtro
    And Verifica Neumro Copy Costi di notifica Inclusi 2 IUN "UGVQ-LHRV-LEZN-202511-D-1"
...
##  Ibrido con costi
    ...
    And Cliccare sulla notifica restituita dal filtro
    And Verifica Neumro Copy Costi di notifica Inclusi 1 IUN "VDUE-NKNT-KGZL-202505-P-1"
    And Verifica testo "L'importo finale potrebbe essere diverso da quello indicato"
    And Nella sezione Dettaglio Notifiche si clicca su l'opzione Indietro
    And  Aspetta 0 secondi
...
##  1 Modello F24 senza costi
    And Nella pagina piattaforma notifiche destinatario si effettua la ricerca per codice IUN "PEYQ-LUDU-YMHV-202511-J-1"
    And Cliccare sulla notifica restituita dal filtro
    And Verifica Neumro Copy Costi di notifica Inclusi 0 IUN "PEYQ-LUDU-YMHV-202511-J-1"
    And Verifica testo "L'importo finale potrebbe essere diverso da quello indicato"
    And Nella sezione Dettaglio Notifiche si clicca su l'opzione Indietro
    And  Aspetta 0 secondi
...
##  2 Avviso pago Pa senza costi
    ...
    And Nella sezione Dettaglio Notifiche si clicca su l'opzione Indietro
    And  Aspetta 0 secondi
##  2 Modello F24 senza costi (Da Rifare)
    And Nella pagina piattaforma notifiche destinatario si effettua la ricerca per codice IUN "DLGQ-NGZK-QDKH-202511-H-1"
    And Cliccare sulla notifica restituita dal filtro
    And Verifica Neumro Copy Costi di notifica Inclusi 0 IUN "DLGQ-NGZK-QDKH-202511-H-1"
    And Verifica testo "Puoi pagare questa notifica tramite F24. Per vedere i dettagli, apri i modelli. L'importo finale potrebbe essere diverso da quello indicato"
    And Nella sezione Dettaglio Notifiche si clicca su l'opzione Indietro
    And  Aspetta 0 secondi
##  Ibrido senza costi
