Feature: Mittente invia una notifica digitale a destinatario, KO invio sia a domicilio di piattaforma che a domicilio speciale

  @TestSuite
  @TA_invioNotificaDomicilioDiPiattaformaKODomicilioSpecialeKO
  @mittente
  @invioNotifiche
  @recapitiPF

  Scenario: PN-9250 - Mittente invia una notifica digitale a destinatario, KO invio sia a domicilio di piattaforma che a domicilio speciale
