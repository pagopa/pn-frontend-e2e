Feature: Mittente genera una notifica tramite destinatario con pec
  ...
  Scenario: Mittente genera una notifica tramite destinatario con pec
    ...
    And Nella section Destinatario inserire nome cognome e codice fiscale da destinatario "destinatarioPec"
    And Nella section Destinatario cliccare su aggiungi indirizzo fisico, compilare i dati del destinatario "destinatarioPec"
    And Cliccare su continua
    ...
    And Si visualizza correttamente la pagina Piattaforma Notifiche
    And Nella pagina Piattaforma Notifiche inserire il codice fiscale del destinatario "destinatarioPec"
