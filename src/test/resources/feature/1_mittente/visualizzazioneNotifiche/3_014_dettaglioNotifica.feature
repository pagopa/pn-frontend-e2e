Feature: Mittente visualizza il dettaglio di una notifica
  ...
  Background: Login mittente
    ...
    And Nella pagina Piattaforma Notifiche inserire il codice IUN della notifica "DatiiNotifica"
  ...
  Scenario: Mittente visualizza dettaglio notifica
    ...
    # In caso di notifiche multidestinatario si visualizzano i codici fiscali di tutti i destinatari della notifica
