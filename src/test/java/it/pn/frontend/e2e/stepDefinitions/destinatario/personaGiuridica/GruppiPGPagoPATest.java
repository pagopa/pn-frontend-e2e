...
public class GruppiPGPagoPATest extends BasePage {
    ...
    public void nellaPaginaPiattaformaNotifichePersonaGiuridicaSiCliccaSulBottoneGruppi() {
        logger.info("Si clicca sul bottone Gruppi");
    ...
    public void nellaPaginaUtentiSiEffettuaLaLoginTramiteCredenziali(Map<String, String> nuovoUtente) {
        logger.info("Si effettua la login nella pagina di reindirizzamento dei gruppi");
    ...
    public void siVisualizzaCorrettamenteLaPaginaGruppi() {
        logger.info("Si attende il corretto caricamento della pagina gruppi");
        gruppiPGPage.waitLoadGruppiPage();
    }

    @And("Si clicca sul bottone Crea gruppo")
    public void siCliccaSulBottoneCreaGruppo() {
        logger.info("Si clicca sul bottone crea gruppo");
    ...
    public void siVisualizzaCorrettamenteLaPaginaCreaGruppo() {
        logger.info("Si attende il corretto caricamento della pagina crea nuovo gruppo");
    ...
    public void siCompilanoICampiPerLaCreazioneDiUnNuovoGruppo(Map<String, String> gruppo) {
        logger.info("Si compilano i campi per la creazione di un nuovo gruppo");
    ...
    public void siControllaCheIlBottoneConfermaSiaAbilitatoELoSiClicca() {
        logger.info("Si controlla che il bottone conferma sia abilitato e lo si clicca");
    ...
    public void siVisualizzaCorrettamenteLaPaginaDiRiepilogoDelGruppo(String nomeGruppo) {
        logger.info("Si verifica che la pagina di riepilogo del gruppo {} creato sia visualizzata correttamente", nomeGruppo);
    ...
    public void siVisualizzaCorrettamenteLaPaginaDiRiepilogoDelGruppoDisattivato(String nomeGruppo) {
        logger.info("Si verifica che la pagina di riepilogo del gruppo {} sospeso sia visualizzata correttamente", nomeGruppo);
    ...
    public void siRitornaAllaPaginaPrincipaleDellaSezioneGruppi() {
        logger.info("Si ritorna alla pagina principale");
    ...
    public void siCliccaSulBottone(String azioneSuGruppi) {
        logger.info("Si clicca sul bottone {}", azioneSuGruppi);
    ...
    public void siCliccaSulBottoneDelPopup(String azioneSuGruppi) {
        logger.info("Si clicca sul bottone {} del popup", azioneSuGruppi);
    ...
    public void siControllaCheICampiDelGruppoSonoModificabili() {
        logger.info("Si controlla che i campi siano modificabili");
    ...
    public void siVisualizzaIlPopupDiConfermaConLaScritta(String testoPopUp) {
        logger.info("Si controlla venga visualizzato il popup di conferma con la scritta {}", testoPopUp);
    ...
    public void siControllaCheLeModificheSianoStateSalvate() {
        logger.info("Si controlla che siano state salvate correttamente le modifiche");
    ...
    public void siVerificaCheVengaMostratoCorrettamenteIlPopupDiSospensione() {
        logger.info("Si controlla che il popup per la sospensione del gruppo sia mostrato in maniera corretta");
    ...
    public void nellaPaginaDiDescrizioneDelGruppoSiVisualizzaLaVoceSospeso() {
        logger.info("Si controlla sia presente la voce sospeso nella pagina di descrizione del gruppo");
    ...
    public void siVerificaCheVengaMostratoCorrettamenteIlPopupDiRiattivazione() {
        logger.info("Si verifica che il pop up di riattivazione del  gruppo venga mostrato correttamente");
    ...
    public void siVerificaCheVengaMostratoCorrettamenteIlPopupDiDuplicazione() {
        logger.info("Si verifica che il pop up di duplicazione del  gruppo venga mostrato correttamente");
    ...
    public void siVerificaCheLaPaginaDiDuplicazioneDelGruppoSiVisualizzaCorrettamente() {
        logger.info("Si verifica che la pagina di duplicazione del gruppo si visualizza correttamente");
    ...
    public void siVerificaCheVengaMostratoCorrettamenteIlPopupDiEliminazione() {
        logger.info("Si verifica che il pop up di eliminazione del  gruppo venga mostrato correttamente");
    ...
    public void siIlGruppoCreatoInizialmente(String azioneGruppo, String nomeGruppo) {
        logger.info("Si elimina il gruppo {} creato all'inizio del test", nomeGruppo);
        webTool.waitTime(3);
