...
public class AvvisiAvvenutaRicezionePagoPaTest {
    ...
    public void laPaginaAvvisiDiAvvenutaRicezioneSezioneDatiDelDestinatarioÃˆVisualizzataCorrettamente() {
    ...
    public void nellaPaginaAvvisiDiAvvenutaRicezioneSezioneDatiDelDestinatarioIlSoggettoGiuridicoÃˆSelezionatoDiDefaultComePersonaFisica() {
    ...
    public void laPaginaAvvisiDiAvvenutaRicezioneSezioneAvvisiDiAvvenutaRicezioneÈVisualizzataCorrettamente() {
        AvvisiAvvenutaRicezionePage avvisiAvvenutaRicezionePage = new AvvisiAvvenutaRicezionePage(this.driver);
