...
import it.pn.frontend.e2e.api.SpidAcs;
import it.pn.frontend.e2e.api.SpidDemoLogin;
import it.pn.frontend.e2e.api.SpidDemoStart;
import it.pn.frontend.e2e.api.SpidLogin;
...
public class LoginDestinatarioPagoPA {
    ...
    public void ilPortaleDestinatarioECaricatoCorrettamenteTramiteRequestMethod() {
        boolean urlWithTokenFound = false;
        int numProvaLogin = 0;
        while(numProvaLogin<10){
            if(this.readUrlLoginDestinatarioWithToken().equalsIgnoreCase("301")){
    ...
    private String readUrlLoginDestinatarioWithToken(){
        logger.info("spid-login");

        SpidLogin spidLogin = new SpidLogin();
        spidLogin.setSpidLoginEndPoint("https://hub-login.spid.test.notifichedigitali.it/login");
        ...
        spidDemoStart.setSpidDemoStartEndPoint("https://spid-saml-check.spid.test.notifichedigitali.it/demo/start");
        ...
        SpidDemoLogin spidDemoLogin = new SpidDemoLogin(
                this.datiDestinatario.get("user").toString(),
                this.datiDestinatario.get("pwd").toString(),
        ...
        spidDemoLogin.setSpidDemoLoginEndPoint("https://spid-saml-check.spid.test.notifichedigitali.it/demo/login");
        ...
        spidAcs.setSpidAcsEndPoint("https://hub-login.spid.test.notifichedigitali.it/acs");
        spidAcs.runSpidAcs();
        ...
        return urlDestinatario.get("responseCode");
