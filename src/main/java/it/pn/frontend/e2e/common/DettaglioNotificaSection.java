...
public class DettaglioNotificaSection extends BasePage {
    ...
    public void checkMessaggioScadenzaDownload() {
        ...
        getWebDriverWait(30).withMessage("Il messaggio Al momento non è possibile scaricare il documento non è visibile").until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[contains(text(), 'Al momento non è possibile scaricare il documento')]")));
    }
