...
public class RestRaddAlternative {
    ...
    public StartTransactionResponse startTransactionRaddAlternative(String tipoDestinatario, String codiceFiscale) {
        ...
        final StartTransactionRequest startTransactionRequest = new StartTransactionRequest(codiceFiscale,tipoDestinatario, notificationSingleton.getIun(Hooks.getScenario()));
...
log.info(startTransactionRequest.toString());
    ...
    public CompleteTransactionResponse completeTransactionRaddAlternative() {
        ...
        final CompleteTransactionRequest completeTransactionRequest = new CompleteTransactionRequest();
