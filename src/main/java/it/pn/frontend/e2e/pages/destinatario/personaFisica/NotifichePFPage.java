...
public class NotifichePFPage extends BasePage {
    ...
    public void waitLoadNotificheDEPage() {
        getWebDriverWait(60).withMessage("Notifiche DE Page non caricata correttamente: il titolo non è visibile").until(ExpectedConditions.visibilityOf(driver.findElement(By.id("Le tue notifiche-page"))));
