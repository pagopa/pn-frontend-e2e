    ...
    public void waitLoadAccediAreaRiservataPGPage() {
        try {
           ...
           // spidButton = driver.findElement(By.id("spidButton"));
            ...
            getWebDriverWait(30).withMessage("Lo spid Button della pagina Accedi Area Riservata non è visibile").until(ExpectedConditions.elementToBeClickable(By.id("spidButton")));
