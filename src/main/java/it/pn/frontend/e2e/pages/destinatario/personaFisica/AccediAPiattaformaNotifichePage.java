...
public class AccediAPiattaformaNotifichePage extends BasePage {
    ...
    public void checkoutPagamento() throws InterruptedException {
        ...
        //Select Nexi
//        getWebDriverWait(30).withMessage("Il bottone modifica non è cliccabile").until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@aria-label='Change payment service provider (PSP)']")));
