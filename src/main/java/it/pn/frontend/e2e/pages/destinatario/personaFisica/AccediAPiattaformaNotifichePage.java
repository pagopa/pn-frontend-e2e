...
public class AccediAPiattaformaNotifichePage extends BasePage {
    ...
    public void waitLoadAccediAPiattaformaNotifichePage() {
        ...
        getWebDriverWait(30).withMessage("Il titolo della pagina accedi a piattaforma notifiche non è visibile").until(ExpectedConditions.visibilityOfAllElements(driver.findElement(By.id("login-mode-page-title"))));
        getWebDriverWait(30).withMessage("Il bottone login della pagina accedi a piattaforma notifiche non è visibile e cliccabile").until(ExpectedConditions.and(ExpectedConditions.visibilityOfAllElements(driver.findElement(By.id("spidButton"))), ExpectedConditions.elementToBeClickable(driver.findElement(By.id("spidButton")))));
