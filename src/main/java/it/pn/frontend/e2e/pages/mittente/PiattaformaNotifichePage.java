...
//        notificationsTable = driver.findElement(By.id("notifications-table"));
    ...
    public void clickSuNotifica() {
        ...
        getWebDriverWait(70).withMessage("notifica non esistente").until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//table[@id='notifications-table']//tr[.//button[contains(text(),'" + iun + "')]]")));
        By notification = By.xpath("//table[@id='notifications-table']//tr[.//button[contains(text(),'" + iun + "')]]");
