...
public class PiattaformaNotifichePGPAPage extends BasePage {
    ...
    public void waitLoadPiattaformaNotificaPage(String ragioneSociale) {
        try {
           ...
           // WebElement dataFineFieldBy = driver.findElement(By.id("endDate"));
            getWebDriverWait(60).withMessage("Il titolo della pagina Notifiche PG non è visibile").until(ExpectedConditions.visibilityOf(driver.findElement(By.id("Notifiche di " + ragioneSociale + "-page")));
    ...
    public void clickSuDelegeButton() {
        try {
            getWebDriverWait(10).withMessage("Sezione deleghe nel side menu non visualizzata").until(ExpectedConditions.visibilityOf(driver.findElement(By.id("side-item-Deleghe"))));
