    ...
    public void waitLoadPiattaformaNotificaPage(String ragioneSociale) {
        try {
           ...
           // WebElement dataFineFieldBy = driver.findElement(By.id("endDate"));
            getWebDriverWait(20).withMessage("Il titolo della pagina Notifiche PG non è visibile").until(ExpectedConditions.visibilityOf(driver.findElement(By.id("Notifiche di " + ragioneSociale + "-page"))));
